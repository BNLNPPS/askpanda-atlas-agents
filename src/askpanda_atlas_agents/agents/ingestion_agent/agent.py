...
class IngestionAgent(Agent):
    ...
    :class:`~askpanda_atlas_agents.agents.ingestion_agent.bigpanda_jobs_fetcher.BigPandaJobsFetcher`
    ...
    the schema from :mod:`askpanda_atlas_agents.common.storage.schema`.
    """
